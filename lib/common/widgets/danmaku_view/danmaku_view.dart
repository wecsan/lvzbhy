...
class _DanmakuViewState extends State<DanmakuView> {
  ...
  void initState() {
    ...
    _controller = widget.danmakuController;
    _controller.setListener(addItems, updateOption, pause, resume, clear);
  ...
  Size calculateTextSize(String value, double fontSize) {
    ...
    painter.layout(maxWidth: 1500);

    return Size(painter.width + fontSize, painter.height);
  }
}
